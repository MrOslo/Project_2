...
#Second Frame
fram2=Frame(root,bd=3,width=340,height=280,bg="white",relief=GROOVE)
...
scrolbar1.place(x=320,y=0,height=300)
...
Button(frame4,text="$how Data",width=10,height=2,font="arial 14 bold",command=Show).place(x=180,y=30)
